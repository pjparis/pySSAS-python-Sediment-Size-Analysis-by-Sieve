...
class SedSASample(object):
    ...
    def __init__(self, userInputs ):
        ...
        df1=df0.loc[ df0['Transect'] == self.transect ].copy().T                  
    ...
    # ####### End of internal temporary df calcs. The data frame df is now ready to get to 
    # work!    
